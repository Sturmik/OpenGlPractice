...
int main()
{
    ...
    std::string fragmentShader2 =
        ...
        "}\n";
        unsigned int shader1 = CreateShader(vertexShader, fragmentShader);
        unsigned int shader2 = CreateShader(vertexShader, fragmentShader2);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // using shader for first triangle
        glUseProgram(shader1);
        // draw first triangle
        glBindVertexArray(VAOs[0]);
        glDrawArrays(GL_TRIANGLES, 0, 3);

        // using shader for second triangle
